...
def get_data():
    if (symbol == "FOOLAD"):
        df = pd.read_csv("C:/Users/Farshad/Desktop/MyCode/Python/myBourse/session29-S Mobarakeh Steel-a.csv")
        
        # I added this line for data received by app
        df["Date"] = pd.to_datetime(df["Date"], format="%Y%m%d")
        
    elif (symbol == "KHODRO"):
        df = pd.read_csv("C:/Users/Farshad/Desktop/MyCode/Python/myBourse/session29-Iran Khodro-a.csv")
        
        # I added this line for data received by app
        df["Date"] = pd.to_datetime(df["Date"], format="%Y%m%d")
        
    elif (symbol == "AMZN"):
        df = pd.read_csv("C:/Users/Farshad/Desktop/MyCode/Python/myBourse/session29-AMZN.csv")
    elif (symbol == "TSLA"):
        df = pd.read_csv("C:/Users/Farshad/Desktop/MyCode/Python/myBourse/session29-TSLA.csv")
